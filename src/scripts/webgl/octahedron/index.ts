...
import octahedronFrag from './glsl/octahedron.frag'
import octahedronVert from './glsl/octahedron.vert'
...
export default class Octahedron {
  ...
  createObj() {
    const geometry = new OctahedronGeometry(90, 20)
    ...
    return new Mesh(
      ...
      new RawShaderMaterial({
        ...
        vertexShader: octahedronVert,
        fragmentShader: octahedronFrag,
        transparent: true
        // wireframe: true
        // side: DoubleSide
      })
